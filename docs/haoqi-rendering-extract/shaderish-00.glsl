...
float hoverDotCoverage(vec2 screenUv) {
  ...
  // æé¿ä¸­å¿åå¤çè¿æ¸¡ç¯å®½åº¦ï¼è®© hover æ©æ£æ´æåï¼ä¸ä¼åºç°ç­ä¿ç¡¬è¾¹
...
/** hover æªçææ¶ 0ï¼æ­¤æ¶è·³è¿ mapHover éæ ·çä¸å tex2Dï¼mip-0 è·¯å¾ä¸åæ¯å®å¨ï¼ */
...
/** è¾¹ç¼ AAï¼aaRef = fwidth(localUv)ï¼ä¸éé¿åé¤é¶ */
